...
<body>
    ...
    <div class="sidebar">
        ...
        <div>
            <input type="checkbox" id="accepted" name="filter" value="2" onclick="handleAccepted()" checked>
    ...
    <div class="main">
        <table border='1' id="bookingsTable">
            ...
            $getBooking = "SELECT * FROM bookings WHERE worker_id=$userId AND status=2 ORDER BY dateTime ASC";
