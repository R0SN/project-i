...
if (!isset($_SESSION['user_id'])) {
    header("location: ../beforeLogin/signin.php");
    exit();
} else {
                ...
                echo "
                    ...
                    <p>Skill:  ".$skill."</p>
                        ...
                        if (in_array($certificateExtension, ['jpg', 'jpeg', 'png'])) {
                            echo "<div class='certiImg' style='position: absolute; top: 50px; left: 50px;'>Certificate:<a href='$certiImg' target='_blank'><img src='$certiImg' alt='$name' style='height: 90vh'></a></div>";
                        } elseif ($certificateExtension === 'pdf') {
                            echo "<div class='certiImg' style='position: absolute; top: 50px; left: 900px;'>Certificate:<embed src='$certiImg' style='height: 90vh'></div>";
                        } else {
